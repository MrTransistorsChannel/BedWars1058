...
public class Permissions {
    ...
    public static final String PERMISSION_FORCESTARTADMIN = BedWars.mainCmd+".forcestartadmin";
    public static final String PERMISSION_ARENASTART = BedWars.mainCmd+".arenastart";
    ...
    public static final String PERMISSION_SPECTATOR_BYPASS = BedWars.mainCmd+".spectator.bypass";
