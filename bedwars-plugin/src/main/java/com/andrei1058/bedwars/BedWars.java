...
public class BedWars extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // Register events
        registerEvents(new ShiftListener(), new EnderPearlLanded(), new QuitAndTeleportListener(), new BreakPlace(), new DamageDeathMove(), new Inventory(), new Interact(), new RefreshGUI(), new HungerWeatherSpawn(), new CmdProcess(),
