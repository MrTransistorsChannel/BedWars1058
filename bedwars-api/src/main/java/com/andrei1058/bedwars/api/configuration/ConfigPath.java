...
public class ConfigPath {
    ...
    public static final String GENERAL_CONFIGURATION_DISABLE_INTERACTS = "inventories.disable-interacts";
    ...
    public static final String ARENA_ENABLE = "enable";
    ...
    public static final String GENERAL_TNT_FUSE_TIME = "tnt-fuse-time";
